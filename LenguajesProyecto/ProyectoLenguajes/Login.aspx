...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <form class="form-conatiner">
      ...
      <div class="form-group">
        ...
        <asp:TextBox ID="TextBoxPassword" type="password" placeholder="Contraseña" class="form-control" runat="server" required=""></asp:TextBox>
      </div>

        <asp:Button ID="ButtonLoggin"  class="btn btn-success btn-block" runat="server" Text="Enviar"  />
    </form>
